...
<h1 align="center">
  💻 Gatsby's blog site linked with Netlify headless CMS
</h1>

<span><b>Demo:</b> https://inspiring-easley-acf800.netlify.app/</span> <br>
<span><b>Add blog here:</b> https://inspiring-easley-acf800.netlify.app/admin</span>
...
1.  **Start developing.**
    ...
    ```shell
    cd gatsby-static-site-genarator
    gatsby develop
    ```
...
3.  **`/content/blog`**:  This directory will automatically add all the blogs that is created using the CMS

4.  **`/content/blog`**:  This directory will automatically add all the images that is created using the CMS
